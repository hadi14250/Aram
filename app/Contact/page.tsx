            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900">UAE</h3>
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900">UK</h3>
                    <div className="space-y-4">


                      <div>
                        <p className="text-gray-600">Amal Aljord:</p>
                        <a
                          href="tel:+44 7464 239684"
                          className="text-gray-600 hover:text-gray-800 transition-colors duration-300"
                        >
                          +44 7464 239684
                        </a>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900">UAE Address</h3>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900">UK Address</h3>
                    <p className="text-gray-600">London, 5 Brayford Square</p>
                    <p className="text-gray-600">E1 0SG</p>
                  </div>
                </div>
