...
const WorkingHours: React.FC = () => {
  return (
    <div className="bg-gradient-to-r from-green-900 to-green-800 rounded-xl shadow-2xl overflow-hidden transform hover:scale-105 transition-all duration-300">
