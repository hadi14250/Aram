...
const projects = [
  ...
  {
    title: '⁠4-Star Hotel Al majaz, Sharjah',
    category: 'commercial',
  ...
  {
    title: '⁠Villa Al safa2, Jumeirah, Dubai',
    category: 'residential',
    // location: 'River City',
    // year: '2022',
